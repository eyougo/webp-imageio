...
public class WebPImageReaderSpi extends ImageReaderSpi {
    ...
    //VP8L means WebP Lossless Bitstream Specification, @see https://developers.google.com/speed/webp/docs/webp_lossless_bitstream_specification
    ...
    public boolean canDecodeInput(Object source) throws IOException {
        ...
        try {
            ...
            stream.readFully(b);
            if (!Arrays.equals(b, VP8_) && !Arrays.equals(b, VP8X) && !Arrays.equals(b, VP8L)) {
                return false;
            }
        } finally {
